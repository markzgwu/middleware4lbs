...
WeightedSlopeOne so = new WeightedSlopeOne(data);
...
WeightedSlopeOne.print(user);
System.out.println("Getting...");
WeightedSlopeOne.print(so.predict(user));
//
user.put(item4,0.2f);
System.out.println("Inputting...");
WeightedSlopeOne.print(user);
...
public WeightedSlopeOne(Map<UserId,Map<ItemId,Float>> data) {
mData = data;
buildDiffMatrix();
}
