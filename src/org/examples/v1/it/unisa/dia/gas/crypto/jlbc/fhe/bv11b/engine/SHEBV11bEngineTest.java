...
import edu.it.unisa.dia.gas.crypto.jlbc.fhe.bv11b.engine.SHEBV11bEngine;
import edu.it.unisa.dia.gas.crypto.jlbc.fhe.bv11b.generators.SHEBV11bKeyPairGenerator;
import edu.it.unisa.dia.gas.crypto.jlbc.fhe.bv11b.params.*;
...
//                    new BigInteger(95, 12, new SecureRandom()),
            ...
            System.out.println("ct1.length:"+ct1.length);
            System.out.println("ct2.length:"+ct2.length);
            ...
            System.out.println(mul.toBigInteger());
