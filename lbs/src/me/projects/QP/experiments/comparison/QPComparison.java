...
public final class QPComparison implements ILog{
	...
	//TargetObjectIDs = new String[]{"39"};
	TimeStamps = TagsBatch.getTags(21);
	...
	public void test1(){
		...
		//System.gc();
		{
		final WarperQP schemewarper = new WarperQP(new QPBaseline());
	...
	public void test2(){
		...
		{
		final WarperQP schemewarper = new WarperQP(new QPNewcasper(PrivacyProfile));
		schemewarper.mount(datasampler);
		schemewarper.mount(dbsp1,bufferzone);
		schemewarper.mount(CRChecker);
		final TargetReguestRecorder TarReqRec= new TargetReguestRecorder();
	...
	public static void main(String[] args) {
		QPComparison me = new QPComparison();
