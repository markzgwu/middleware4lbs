...
public final class CheckIndexAndNoIndexNN {
	...
	public static HashSet<RequestUser> getReq1(){
		...
		r.location = new LocationCoordinate("40.016608,116.407361");
	...
	public static HashMap<String, String> index(RequestUser req){
		...
		IndexNNQuery test = new IndexNNQuery(req);
		test.loaddata();
		POIDB = test.POIDB;
	...
	public static void check(HashMap<String, String> m1, HashMap<String, String> m_large){
		for(String uid:m_large.keySet()){
			...
			if(!b){
				System.out.println("Check:"+uid+";"+POIDB.get(uid).getData());
			}
		}
	}
	...
	public static void main(String[] args) {
		...
		for(RequestUser req:r_pool){
			System.out.println(req.argument.toString()+";Location:"+req.location.toLocation_yx());
