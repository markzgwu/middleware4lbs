...
public final class LocFARKBA implements ILog{
		...
		String worker(String title){
			...
			for(int i=0;i<obj_count;i++){
				...
				if(sampleobjid.equals(targetobjid)){
		...
		public static void main(String[] args) {
			...
			output = Format4Matlab.output4matlab("t="+threshold, result);
