...
public final class Experiment11 {
	static int round = 10;
	...
	public static void experiment_attacker5(){
		...
		for(int i=0;i<1;i++){
			...
			for(int i1 = 1;i1<21;i1++){
				double[] far_frr = experiment_attacker5(i,i1);
				far+=far_frr[0]+",";
				frr+=far_frr[1]+",";
			}
	...
	public static double[] experiment_attacker5(int profile_len,int movies_len){
		...
		parameters.profile_len = profile_len;
